...
public  final class AppendEntriesRequest extends
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return rsocket.playground.raft.rpc.Rpc.internal_static_AppendEntriesRequest_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return rsocket.playground.raft.rpc.Rpc.internal_static_AppendEntriesRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            rsocket.playground.raft.rpc.AppendEntriesRequest.class, rsocket.playground.raft.rpc.AppendEntriesRequest.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof rsocket.playground.raft.rpc.AppendEntriesRequest)) {
      return super.equals(obj);
    }
    rsocket.playground.raft.rpc.AppendEntriesRequest other = (rsocket.playground.raft.rpc.AppendEntriesRequest) obj;
  ...
  public static rsocket.playground.raft.rpc.AppendEntriesRequest parseFrom(
  ...
  public static rsocket.playground.raft.rpc.AppendEntriesRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static rsocket.playground.raft.rpc.AppendEntriesRequest parseFrom(
  ...
  public static rsocket.playground.raft.rpc.AppendEntriesRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static rsocket.playground.raft.rpc.AppendEntriesRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static rsocket.playground.raft.rpc.AppendEntriesRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(rsocket.playground.raft.rpc.AppendEntriesRequest prototype) {
  ...
  public static final class Builder extends
      ...
      rsocket.playground.raft.rpc.AppendEntriesRequestOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return rsocket.playground.raft.rpc.Rpc.internal_static_AppendEntriesRequest_descriptor;
    }
    ...
    // Construct using rsocket.playground.raft.rpc.AppendEntriesRequest.newBuilder()
    private Builder() {
    ...
    public rsocket.playground.raft.rpc.AppendEntriesRequest getDefaultInstanceForType() {
      return rsocket.playground.raft.rpc.AppendEntriesRequest.getDefaultInstance();
    }

    public rsocket.playground.raft.rpc.AppendEntriesRequest build() {
      rsocket.playground.raft.rpc.AppendEntriesRequest result = buildPartial();
    ...
    public rsocket.playground.raft.rpc.AppendEntriesRequest buildPartial() {
      rsocket.playground.raft.rpc.AppendEntriesRequest result = new rsocket.playground.raft.rpc.AppendEntriesRequest(this);
      result.term_ = term_;
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof rsocket.playground.raft.rpc.AppendEntriesRequest) {
        return mergeFrom((rsocket.playground.raft.rpc.AppendEntriesRequest)other);
      } else {
    ...
    public Builder mergeFrom(rsocket.playground.raft.rpc.AppendEntriesRequest other) {
      if (other == rsocket.playground.raft.rpc.AppendEntriesRequest.getDefaultInstance()) return this;
      if (other.getTerm() != 0) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      rsocket.playground.raft.rpc.AppendEntriesRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (rsocket.playground.raft.rpc.AppendEntriesRequest) e.getUnfinishedMessage();
  ...
  private static final rsocket.playground.raft.rpc.AppendEntriesRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new rsocket.playground.raft.rpc.AppendEntriesRequest();
  }

  public static rsocket.playground.raft.rpc.AppendEntriesRequest getDefaultInstance() {
