...
public class SenderLastAppliedOperator extends FluxOperator<Payload, Payload> {
    ...
    SenderLastAppliedOperator(Flux<? extends Payload> source, Node node, ZomkyStorage zomkyStorage) {
        super(source);
        this.node = node;
    ...
    private static class PublishLastAppliedSubscriber implements CoreSubscriber<Payload> {
